...
\subsection{MOOC Server}
      ...
      \begin{figure}[H]
      \centering
      \includegraphics[width=.95\linewidth]{cytomine_home.png}
...
Students have to study tissue samples. (Figure \ref{fig:lame_example})
      ...
      \begin{figure}[H]
      \centering
      \includegraphics[width=.95\linewidth]{lame_cytomine.png}
...
\subsection{General Goals}
    ...
    This analysis returns statistics in many forms since there is such a wide range of variables. (Figure \ref{fig:highlevel})
      ...
      \begin{figure}[H]
      \centering
      \includegraphics[width=.95\linewidth]{highlevel.jpg}
...
\section{Tools and Methods}
    ...
    \subsection{Three Separate Components}
		...
		\subsubsection{Data Acquisition}
          ...
          Reference annotations are drawn similarly to the example in Figure \ref{fig:annnn} that are indicated by numbers.\\
            \begin{figure}[H]
              \centering
              \includegraphics[width=.4\linewidth]{annotations.png}
        ...
        \item[\textbullet]  \textbf{User Positions :}\newline
         ...
         \begin{figure}[H]
            ...
            \includegraphics[width=\textwidth]{zooms1.png}
            \caption{Zooms 1 to 3}
            \end{subfigure}
            \begin{subfigure}[b]{0.3\textwidth}
            \includegraphics[width=\textwidth]{zooms2.png}
            \caption{Zoom 2}
            \end{subfigure}
            \begin{subfigure}[b]{0.3\textwidth}
            \includegraphics[width=\textwidth]{zooms3.png}
            \caption{Zoom 3}
            \end{subfigure}

            \begin{subfigure}[b]{0.3\textwidth}
            \includegraphics[width=\textwidth]{zooms4.png}
            \caption{Zoom 4}
            \end{subfigure}
            \begin{subfigure}[b]{0.3\textwidth}
            \includegraphics[width=\textwidth]{zooms5.png}
            \caption{Zoom 5}
            \end{subfigure}
            \begin{subfigure}[b]{0.3\textwidth}
            \includegraphics[width=\textwidth]{zooms6.png}
       ...
       \begin{figure}[H]
        \centering
         \includegraphics[width=.6\linewidth]{directories.png}
    ...
    \begin{itemize}
        ...
        \item[\textbullet] \textbf{Output activity over time figures :} These figure represents the activity over time of a set of students or simply an individual in regards to different modules.
        ...
        \item[\textbullet] \textbf{Output Gaze Map figures :} These figures represents the heatmaps of the student activity in regards to an image.
        ...
        Methods include :
        \begin{itemize}
            \item \textbf{Raw Heatmap :} For each position, the respective gaussian values are added into the heatmap at the right position.
            ...
            \item \textbf{Logarithmic Heatmap :} The heatmap is generated similarly but a $Log_{10}$ normalizer applied at the end for each pixel.
            ...
            \item \textbf{Logarithmic Heatmap Relative to an image :} The idea would be to reimplement the previous heatmap for every user of a specific image and standardize the scale.
            ...
            \item \textbf{Logarithmic Heatmap Relative to a user :} This is the same concept as previously but the goal is to compare activity of the same student across multiple images.
            This has the same advantages and drawbacks as the previous heatmap.
            \item \textbf{Reduced Heatmap :} A interesting observation is that it's hard to quantify user observations for long durations.
...
\section{Conclusion}
    ...
    Overall, there were some interesting results. This tool provided the means to analyze and visualize user behavior on Cytomine.
