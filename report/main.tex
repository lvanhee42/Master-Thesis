...
This section will introduce what the study is about.
It will start by introducing Cytomine which is a project that provides the means and the tools that made this work possible.
This is followed by an overview of the MOOC server and the goals set by teachers and developers.
Finally this section will introduce the tools proposed by this project that allows for the analysis of user behavior data extracted from the MOOC.
...
\section{General Goals}
    ...
    The Main objective is to develop a tool to observe how students use use Cytomine.
...
They also often analyze a set of students and how they behave while scanning images.
...
Since they are assessed based on their performance as a whole, this analysis cannot be donne image by image.
...
\chapter{Tools and Methods} \label{chapt:tools}
    ...
    \begin{itemize}
        ...
        These images that are stored with file systems are often very high resolution images.
    \end{itemize}
    ...
    The cytomine Python Client is an add-on to Cytomine for easy communication between the user and the server using the Python programming language.
    ...
    \begin{itemize}
        ...
        These methods often requires a large amount of data to work effectively.
...
\vspace{1cm}
    ...
    \section{Analysis Tool}
		...
		\subsection{Data Acquisition}
			...
			With administrator rights, a user can get a hold of all if not most of the data stored in the SQL and MongoDB databases.
       ...
       \end{figure}
        ...
        For both projects, a csv file containing user information not found on Cytomine was given.
        ...
        The csv file given for the GOLD students therefore contained grades for numerous activities.
        ...
        \begin{itemize}
            ...
            The file is structured similarly to the format described in section \ref{experiments} of Chapter 3.
        ...
        \begin{itemize}
            ...
            This follows the same principles as with the images.
    ...
    \begin{itemize}
        ...
        \item[\textbullet] \textbf{Output Gaze Map figures :} These figures represent the Gazemaps of the student activity in regards to an image.
        ...
        Even though the colors for the reduced Gazemap are lighter, the colors are consistent with every other reduced heatmap that can be generated.
        ...
        The idea is to draw an arrow plot that connects each position to the following position.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            Each category is also represented by a color.
            ...
            This includes a line with a Pearson Correlation to represent the slope of the of the relation.
        \end{itemize}
...
a user during the module's time period. \\
    ...
    Like mentioned before, the tool as a whole can take a while to execute depending on the parameters set.
    ...
    Since the Cytomine server is ran locally and that there are no other users using the application, the download time measured may be quicker than it should be.
    ...
    Generally, users are more active in the GOLD project.
...
\chapter{Data Analysis}
    ...
    Even though the data was obtained for both the GOLD and SILVER projects, the experiments were ran on the GOLD project.
    ...
    This includes Random Forest regression and Extra Trees regression using scikit-learn.\newline
...
\end{itemize}
    ...
    For each Y variable (that were described previously), the model was built fully for the first analysis.
    ...
    When applying machine learning techniques, students with a 0/20 were taken out of the sample because they often default to signing portion of the exam.
	...
	The answer is written on the form under the identification answer.(Figure \ref{fig:qcl})
      \begin{figure}[H]
    \centering
     \includegraphics[width=0.45\linewidth]{images/exam_qcl2.png}
     \includegraphics[width=0.54\linewidth]{images/exam_qcl.png}
    ...
    \end{itemize}
    Similarly, 7 graded exam questions were given to students with 3 being theoretical and 4 being practical.
    Something to note for the practical exam is that there are 2 different exam forms for the QCM and the QROL. This means that half the students are given different questions from the other half.
    ...
    Meanwhile, for the students with the highest grades, there are many more positions as a whole.
    ...
    The Machine Learning results can give more insight on this question.
    ...
    When comparing the learned grades against the original grades, it is noticeable that the estimated grades tend to predict values close to the average of the actual grades.
  ...
  These images can very well be the subject of a question on the exam. (Figures \ref{fig:var_white1}, \ref{fig:var_white2}, \ref{fig:var_white3})
	...
	There are a total of 4 practical exam results excluding the total.
...
It also is shown that the students spent the most time on Cytomine the days before the exam (see Figure \ref{fig:timelapse}).
...
In the end, some images and some modules have more impact than others.  (Figures \ref{fig:im_tp1}, \ref{fig:im_tp2}, \ref{fig:im_tp3},\ref{fig:im_tp4})
   ...
   After studying the results for the practical exams, a question that can be asked is whether or not this analysis can work on Theoretical Exam grades.
    ...
    The goal is to study the correlation between theory and practical.
    ...
    \begin{itemize}
        ...
        A node will be split if the impurity is less than the minimum impurity decrease value.
        Threshold for early stopping tree growth.
        \item[\textbullet] \textbf{Minimum Samples Leaf : 5}\\
        The minimum number of samples required at a leaf node.
        \item[\textbullet] \textbf{Minimum Samples split : 2}\\
        The minimum number of samples required to split an internal node.
        \item[\textbullet] \textbf{Minimum Weight Fraction Leaf : 0.0}\\
...
\chapter{Conclusion}
    ...
    Of course there is still much more information that can be extracted and there may be even more complexity associated to it.
...
\resizebox{\textwidth}{!}{
    \begin{tabular}{|l|l|l|}
        ...
        Cytomine Analysis Tool & https://github.com/scikit-learn & http://scikit-learn.org/stable/ \\ \hline
    \end{tabular}}
