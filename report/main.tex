...
\section{Tools and Methods}
    ...
    \subsection{Machine Learning and ExtraTrees}
    ...
    The ensemble method subject for this project is the Extremely Randomized Trees (ExtraTrees).
    %todo talk about extratrees
    {\color{red} TODO extra trees}
    ...
    The Regressor has been implemented with sklearn.
